...
@implementation TankBigImageCell
...
-(void)setup
{
    ...
    NSArray *views = @[_titleLabel, _originalLabel, _timeLabel, _imageView, _bottomLine];
    ...
    .leftEqualToView(_titleLabel)
    .topSpaceToView(_originalLabel, 9*HEIGHTCONFIG)
    ...
    .rightEqualToView(_titleLabel)
    .heightIs(0.5)
    .topSpaceToView(_imageView, bottomMargin*HEIGHTCONFIG);
