...
- (UIScrollView *)subViewScrollView{
    ...
    if (!_subViewScrollView) {
        _subViewScrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 40, SCREENWIDTH, SCREENHEIGHT-64-40)];
...
{
    tableView.frame=CGRectMake(index*SCREENWIDTH, 0, SCREENWIDTH, SCREENHEIGHT - 64-40);
//    分隔线隐藏
