...
@end
@implementation GENEProgressView
...
-(void)drawText{
    ...
    CGFloat titleY = _circleCenter.y -  titleRect.size.height * 1.2;
    
    [title drawAtPoint:CGPointMake(titleX, titleY)];
    
    //
    NSMutableAttributedString* precentStr = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@",self.contentText]];
    ...
    CGFloat precentY = _circleCenter.y - precentRect.size.height * 0.3;
