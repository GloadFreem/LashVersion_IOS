...
{
    NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:KEY,@"key",self.actionAttendPartner,@"partner",STRING(@"%ld", (long)self.actionId),@"contentId",STRING(@"%ld", (long)page),@"page", nil];
    //开始请求
